...
class TelegramPrinter {
    ...
    private:
        static const constexpr char * header_fmt = "\x1b[1;37;44m%|=10s||%|=10s||%|=13s||%|=20s||%|=10s||%|=10s| \x1b[0m";
        static const constexpr char * row_fmt = "\x1b[1;37;44m%|=10s||%|=10s||%|=13s||%|=20s||%|4d| bytes|%|=10d| \x1b[0m";
        TelegramPrinter() {};
};
#endif
